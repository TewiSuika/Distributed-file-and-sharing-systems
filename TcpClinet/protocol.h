...
#define DEL_DIR_FALSE "delete dir failured: is reguler file"
...
#define DEL_FILE_FALSE "delete file failured: is diretory"
...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_ADD_FRIEND_AGREE,    //加好友同意
    ENUM_MSG_TYPE_ADD_FRIEND_REFUSE,    //加好友拒绝
    ...
    ENUM_MSG_TYPE_SHARE_FILE_NOTE,    //共享文件提问
    ENUM_MSG_TYPE_SHARE_FILE_NOTE_RESPOND,    //共享文件提问回复

    ENUM_MSG_max=0x00ffffffff,
};
